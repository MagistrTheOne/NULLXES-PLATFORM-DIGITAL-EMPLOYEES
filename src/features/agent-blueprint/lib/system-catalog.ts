...
export const SYSTEM_SKILLS: SystemSkillSeed[] = [
  ...
  },
  {
    ...
    instructions:
      "Always call list_missions and list_tasks before reporting. Include goal, status, sends, task queue, and timeline highlights.",
    triggers: { keywords: ["mission", "prospecting", "outbound", "task", "queue"], intents: ["mission_status"] },
    requiredToolSlugs: ["list_missions", "list_tasks"],
    category: "ops",
  },
  {
...
const TOOL_IDS: Record<string, string> = {
  ...
  list_tasks: "c3000003-0003-4003-8003-00000000000a",
