  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-xl lg:mx-0">
        <p className="landing-reveal landing-reveal-1 inline-block border-b border-(--landing-gold) pb-1 text-[10px] font-medium tracking-[0.24em] text-(--landing-gold) uppercase sm:text-[11px] sm:tracking-[0.28em]">
          {t("eyebrow")}
        </p>

        <h1 className="landing-reveal landing-reveal-2 mt-5 font-(family-name:--font-landing-serif) text-[2.05rem] leading-[1.08] tracking-tight text-white sm:mt-6 sm:text-5xl lg:text-[3.25rem]">
          {t("titleLine1")}
          <br />
          {t("titleLine2")}
        </h1>

        <p className="landing-reveal landing-reveal-3 mt-4 max-w-lg text-[14px] leading-relaxed text-white/55 sm:mt-5 sm:text-[15px]">
          {t("body")}
        </p>
        ...
        <div className="landing-reveal landing-reveal-4 mt-7 flex flex-wrap items-center gap-3 sm:mt-8">
          <a
            href="#use-case"
            className="inline-flex items-center gap-2 rounded-full border border-white/25 px-5 py-3 text-sm text-white/85 transition-colors hover:border-white/40 hover:text-white"
          >
            {t("explore")}
