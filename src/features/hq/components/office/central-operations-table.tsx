 ...
 * Shows only operational cards: approvals, handoffs, active missions.
 */
export function CentralOperationsTable({
  ...
  return (
    <group position={[0, 0, 0.2]}>
      {/* Floor ring — quiet ops zone marker */}
      ...
      {/* Soft center glow — restrained, not sci-fi */}
      ...
      {visible.map((item, index) => {
        ...
        return (
          <group key={item.id} position={[x, TABLE_HEIGHT + 0.08, z]}>
            <mesh castShadow>
            ...
            >
              <div className="pointer-events-none w-[110px] select-none rounded border border-white/15 bg-black/85 px-2 py-1.5 shadow-lg">
