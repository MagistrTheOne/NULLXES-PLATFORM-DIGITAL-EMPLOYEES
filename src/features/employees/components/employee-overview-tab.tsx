        ...
        <Card className="border-white/10 bg-[#111111] py-0 text-white">
          ...
          <CardContent className="space-y-4 px-5 py-4">
            {snapshot.recentMissions.length === 0 ? (
              <div className="flex flex-col items-start gap-3 rounded-xl border border-dashed border-white/12 bg-black/20 px-4 py-5">
                <div className="space-y-1">
                  <p className="text-sm font-medium text-white">
                    {tMissions("missionsEmptyTitle")}
                  </p>
                  <p className="text-sm text-white/50">
                    {tMissions("missionsEmpty")}
                  </p>
                </div>
                <Button
                  type="button"
              ...
              <>
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant="outline"
                    className="border-white/10 bg-white/3 text-white/70"
                  >
                    {tMissions("missionsTotal", {
                      count: snapshot.missionsTotal,
                    })}
                  </Badge>
                  <Badge
                    variant="outline"
